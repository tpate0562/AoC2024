...
import Foundation
var result: [[String]] = [[], []]
func loadTSV(filePath: String) -> Void {
    do {
...
for i in 0...99999{theArray[0][i] = i}
for i in 0...999{theArray[2][Int(result[0][i])!]+=1}
for i in 0...999{
    let numberNeeded = Int(result[1][i]);
    theArray[1][numberNeeded!]+=1
}
for i in 0...99999{productSum += theArray[1][i] * theArray[0][i] * theArray[2][i]}
print(productSum)
